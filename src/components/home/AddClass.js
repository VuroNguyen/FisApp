...
const AddClass = ({ navigation }) => {
    ...
    const onClickAdd = (className, teacherName, manager, date, time, building, room) => dispatch(addNewClass(className, teacherName, manager, date, time, building, room))
    ...
    const currentDate = fromDateValue + '-' + toDateValue
        ...
        <View style={styles.container}>
            <View style={{ width: '90%' }}>
                ...
                <View style={{ alignItems: 'flex-end', marginTop: 20 }}>
                    <TouchableOpacity onPress={() => { onClickAdd(localData.class, localData.teacherName, login.data.username, currentDate, localData.time, valueBuilding, valueRoom), navigation.navigate('QLKHHome') }}>
                        <View style={styles.button}>
                            <FontAwesome
                                ...
                                size={18}
                            />
                            <Text style={{ color: 'white', fontSize: 20, marginLeft: 10 }}>LƯU</Text>
                        </View>
                    </TouchableOpacity>
                </View>
